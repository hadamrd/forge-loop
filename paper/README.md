...
thesis it embodies (see [Limitations & Threats to Validity](./11-limitations.md)).
...
| 10 | [The Outer Loop](./10-the-outer-loop.md) | Reliable execution is not improvement: the missing PLAN/CHECK/ACT layer that measures the system, prioritizes by value, and steers its own direction. |
| 11 | [Limitations & Threats to Validity](./11-limitations.md) | Where implementation diverges from thesis. |
| 12 | [Conclusion](./12-conclusion.md) | The governance triad as the durable contribution. |
...
is the outer loop — why reliable execution is still not *improvement*, and the
PLAN/CHECK/ACT layer the system is missing; Section 11 is the honest ledger of
where the artifact does not yet live up to the argument; Section 12 states what
we believe is durable.
