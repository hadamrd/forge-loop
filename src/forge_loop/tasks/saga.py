...
class CompensationKind(StrEnum):
    ...
    # for this kind is a sibling epic issue; until it lands, a stale saga
    # carrying DELETE_BRANCH is quarantined by recovery rather than falsely
    # marked COMPENSATED (see ``control/recovery.py``).
